...
// class UnicodeCharPropertiessCubit extends Cubit<UnicodeCharPropertiesState> {
//   /// Creates a [UnicodeCharPropertiessCubit] with an initial state.
//   UnicodeCharPropertiessCubit()
//       : super(const UnicodeCharPropertiesState.initial());
...
//   Future<void> loadUnicodeCharPropertiess({String? filter}) async {
//     try {
//       emit(
//         _Loading(
...
//   ///
//   /// Returns a list of [UnicodeCharProperties] objects.
//   Future<List<UnicodeCharProperties>>
//       _loadUnicodeCharPropertiessFromCsv() async {
...
//       }
//       return UnicodeCharProperties.fromJson(rowMap);
//     }).toList();
//   }
// }
